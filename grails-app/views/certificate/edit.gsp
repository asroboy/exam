...
<html>
	...
	<body>
		<a href="#edit-certificate" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-certificate" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:certificateInstance, action:'update']" method="PUT"  enctype="multipart/form-data">
