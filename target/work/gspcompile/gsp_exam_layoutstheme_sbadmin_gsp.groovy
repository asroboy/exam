...
class gsp_exam_layoutstheme_sbadmin_gsp extends GroovyPage {
...
printHtmlPart(3)
expressionOut.print(resource(dir: 'images', file: 'favicon_test.ico'))
printHtmlPart(4)
createTagBody(2, {->
createTagBody(3, {->
expressionOut.print(title ?: 'Exam')
})
...
createTagBody(1, {->
printHtmlPart(12)
invokeTag('include','g',51,['view':("layouts/_menu.gsp")],-1)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1516928661304L
