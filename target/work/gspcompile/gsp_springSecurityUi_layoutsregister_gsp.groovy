...
public String getGroovyPageFileName() { "/WEB-INF/plugins/spring-security-ui-1.0-RC3/grails-app/views/layouts/register.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('stylesheet','s2ui',8,['src':("spring-security-ui-register.css")],-1)
printHtmlPart(2)
...
printHtmlPart(2)
invokeTag('javascript','asset',14,['src':("spring-security-ui-register.js")],-1)
printHtmlPart(2)
invokeTag('showFlash','s2ui',15,[:],-1)
printHtmlPart(2)
invokeTag('deferredScripts','s2ui',16,[:],-1)
printHtmlPart(3)
})
