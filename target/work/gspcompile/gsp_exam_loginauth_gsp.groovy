...
class gsp_exam_loginauth_gsp extends GroovyPage {
...
printHtmlPart(9)
invokeTag('linkButton','s2ui',48,['elementId':("register"),'controller':("register"),'messageCode':("spring.security.ui.login.register")],-1)
printHtmlPart(10)
})
invokeTag('form','s2ui',51,['role':("form"),'type':("login"),'focus':("username")],2)
printHtmlPart(11)
})
...
public static final long LAST_MODIFIED = 1516254725567L
