...
class gsp_exam_roleindex_gsp extends GroovyPage {
...
printHtmlPart(2)
invokeTag('set','g',11,['var':("roles"),'value':(com.exam.security.Role.list())],-1)
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1516927968903L
