...
class gsp_exam_certificatecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(certificateInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(certificateInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:certificateInstance, action:'save']),'enctype':("multipart/form-data")],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1517442948162L
